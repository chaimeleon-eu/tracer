...
//    function getTracesByValue(string memory value)  public view returns (string[] memory)  public view returns (string[] memory) {
//        uint len = traces.length;
//        for (uint i=0; i<len; i++) {
//            string trace = traces[i].trace;
//            boolean exists = trace.toSlice().contains(value.toSlice());
//        }
//    }
